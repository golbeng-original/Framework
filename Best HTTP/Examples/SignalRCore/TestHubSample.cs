...
#pragma warning restore
        ...
        public void OnConnectButton()
        {
            ...
            hub = new HubConnection(new Uri("https://localhost:44302/Hub"), protocol);
            ...
            hub.OnConnected += Hub_OnConnectedTemp;
        ...
        private void Hub_OnConnectedTemp(HubConnection hub)
		{
            hub.Send("Send", "my message");
            Thread.Sleep(1000);
            hub.Send("Send", "my message 1");
            Thread.Sleep(1000);
            hub.Send("Send", "my message 2");
            Thread.Sleep(1000);
            hub.Send("Send", "my message 3");
        }
